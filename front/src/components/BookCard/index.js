...
const CardContainer = styled.div`
  ...
  box-shadow: 0 10px 30px rgba(0, 0, 0, 0.1), 0 4px 20px rgba(0, 0, 255, 0.2);
  ...
  &:hover {
    ...
    box-shadow: 0 15px 20px rgba(0, 0, 0, 0.2), 0 6px 15px rgba(0, 0, 255, 0.3);
  }
`;
  ...
  return (
    <CardContainer>
      ...
      <Button onClick={handleButtonClick}>
        {isInFavoritesPage ? <FaTrash /> : <FaHeart />} {/* Mostrar lixeira ou coração */}
      </Button>
    </CardContainer>
  );
}
